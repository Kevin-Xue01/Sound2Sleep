...
class QEEGStreamer(QObject):
    ...
    def connectToHost(self, serial_port: Optional[str] = None):
        ...
        self.bcon.write(b'vvv')  # this will reset Cyton
    ...
    def wait_for_ready(self):
        ...
        if (self.buffer[-3:] == b'$$$'):
            ...
            # self.bcon.write(b'd')  # reset default settings
    ...
    def resync_data(self):
        ...
        n_bytes = 0
        nextbyte = 0
        while (n_bytes < 200) and not ((nextbyte >= 192) and
                                       (nextbyte <= 198)):
            n_bytes += 1
